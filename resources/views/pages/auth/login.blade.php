<x-layouts::auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
            ...
            <div class="relative">
                ...
                @if (Route::has('password.request'))
                    <x-text-link class="absolute end-0 top-0 text-sm" :href="route('password.request')" wire:navigate>
        ...
        @if (config('services.oidc.enabled'))
            ...
            <div class="flex items-center justify-end">
                <flux:button variant="outline" type="button" class="w-full" href="{{ route('auth.oidc.redirect') }}">
