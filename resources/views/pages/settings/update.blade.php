                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <flux:text class="text-sm">
                                <a
                                    href="https://github.com/{{ config('app.github_repo') }}/releases/"
                                    target="_blank"
                        ...
                        <flux:button wire:click="checkForUpdates"> Check for Updates </flux:button>
                    </div>
                @endif
                ...
                <div class="space-y-4">
                            ...
                            <flux:callout.text>
                                ...
                                @if ($backoffUntil)
                                    ...
                                    /><small class="text-xs opacity-75"
                                        >You can try again after {{ \Carbon\Carbon::createFromTimestamp($backoffUntil)->format('H:i') }}.</small>
                                @endif
                            </flux:callout.text>
                        </flux:callout>
                    ...
                    @elseif ($latestVersion && ! $isUpdateAvailable)
                        <flux:callout icon="check-circle" variant="success">
                            ...
                            <flux:callout.text> You are running the latest version. </flux:callout.text>
                        </flux:callout>
                    @endif
                </div>
            </div>
