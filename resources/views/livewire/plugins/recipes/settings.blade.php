...
<flux:modal name="trmnlp-settings" class="max-w-2xl min-w-[600px] space-y-6">
        ...
        <form wire:submit="saveTrmnlpId">
            <div class="grid gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="trmnlp_id" placeholder="TRMNL Recipe ID" />
                    <flux:error name="trmnlp_id" />
                    <flux:description
                        >Recipe ID in the TRMNL Recipe Catalog. If set, it can be used with <code>trmnlp</code>.
                    </flux:description>
                </flux:field>
                ...
                <flux:field>
                    ...
                    <flux:description>
                        ...
                        Pinned versions must be between 2.0.0 and 3.x.x.
                        <a href="https://trmnl.com/framework/releases" target="_blank" rel="noopener noreferrer"
                            >Framework releases</a
                        >.
                    </flux:description>
                </flux:field>
                ...
                <flux:field>
                    ...
                    <flux:description
                        >Enable an Alias URL for this recipe. Your server does not need to be exposed to the internet,
                        but your device must be able to reach the URL.
                        <a href="https://help.usetrmnl.com/en/articles/10701448-alias-plugin">Docs</a></flux:description>
                </flux:field>

                @if ($alias)
                    <flux:field>
                        <flux:label>Alias URL</flux:label>
                        <flux:input value="{{ $this->aliasUrl }}" readonly copyable />
                        <flux:description
                            >Copy this URL to your TRMNL Dashboard. By default, image is created for TRMNL OG; use
                            parameter <code>?device-model=</code> to specify a device model.</flux:description>
                    </flux:field>
                @endif

                @if (config('services.trmnl.liquid_enabled') && $plugin->markup_language === 'liquid')
                    <flux:field>
                        <flux:checkbox wire:model.live="use_trmnl_liquid_renderer" label="Use trmnl-liquid renderer" />
                        <flux:description
                            >trmnl-liquid is a Ruby-based renderer that matches the Core service’s Liquid behavior for
                            better compatibility.</flux:description>
                    </flux:field>
                @endif
                ...
                <flux:field>
                    ...
                    <flux:description>
                        Build forms visually in the
                        <a
                            href="https://usetrmnl.github.io/trmnl-form-builder/"
                            target="_blank"
                            rel="noopener noreferrer"
                            >TRMNL YML Form Builder</a
                        >. Check the
                        <a
                            href="https://help.trmnl.com/en/articles/10513740-custom-plugin-form-builder"
                            target="_blank"
                            rel="noopener noreferrer"
                        >docs</a>
                    ...
                    <div
                        ...
                        class="h-[300px] min-h-[200px] resize-y overflow-hidden"
                    >
